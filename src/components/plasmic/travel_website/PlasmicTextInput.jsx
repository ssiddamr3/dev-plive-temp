...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: ceesG9FOnQw4/css
import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: UI28ryI3XGEc/icon
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: 29ffTJUiBEEd/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__kU2B)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__eecE1)}
              role={"img"}
            />
          ),
